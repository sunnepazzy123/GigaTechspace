...
export const getIdCheckboxComponentAction = async (
  dispatch: Fn,
  id: number
) => {
...
export const deleteIdCheckboxComponentAction = async (
  dispatch: Fn,
  id: number,
...
export const clearCheckboxComponentsAction = (dispatch: Fn) => {
